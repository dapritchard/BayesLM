...
bayes_lm_rcpp_eigen <- function(n                = 100L,
                                p                = 15L,
                                nsamp            = 1e4,
                                prop_nonzero     = 0.2,
                                true_beta_sd     = 2,
                                ...
                                print_stats      = FALSE,
                                write_samples    = FALSE,
                                samples_file_loc = "Samples_Rcpp_Eigen.dat",
                                decomp_method    = "chol") {
    ...
    if (! exists("bayes_lm_rcpp_eigen_")) {
        Rcpp::sourceCpp("Bayes_LM_Rcpp_Eigen.cpp")
    }

    # Call the underlying workhorse function
    bayes_lm_rcpp_eigen_(n, p, nsamp, prop_nonzero, true_beta_sd, true_sigma, sd_x,
